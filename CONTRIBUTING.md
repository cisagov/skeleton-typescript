...
issue](https://github.com/cisagov/skeleton-typescript/issues) in this
...
request](https://github.com/cisagov/skeleton-typescript/pulls), you will
...
pyenv virtualenv <python_version_to_use> skeleton-typescript
pyenv local skeleton-typescript
